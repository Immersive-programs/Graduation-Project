...
class LcdApi:
    ...
    def putstrxy(self, string, cursor_x, cursor_y):

        ocursor_x = self.cursor_x
        ocursor_y = self.cursor_y

        LcdApi.move_to(self, cursor_x, cursor_y)

        for char in string:
            self.putchar(char)

        LcdApi.move_to(self, ocursor_x, ocursor_y)
